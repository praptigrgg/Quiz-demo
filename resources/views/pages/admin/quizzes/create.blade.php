                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.quizzes.store') }}" method="POST" id="quizForm"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="quizTitle" class="form-label">Quiz Title <span
                                        ...
                                        {{-- Related Courses --}}
                                        <div class="mb-3">
                                            <label for="course_id" class="form-label">Related Course <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div id="validDaysField" class="mb-3" style="display:none;">
                                            <label for="valid_days_after_enrollment" class="form-label">Valid Days After
                                                Enrollment</label>
                                            <input type="number" class="form-control" name="valid_days_after_enrollment"
                                                id="valid_days_after_enrollment" min="1">
                                        </div>
                                        ...
                                        <div id="pricingFields" style="display:none;">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="normal_price"
                                                        id="normal_price" step="0.01">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="discount_price" class="form-label">Discount Price</label>
                                                    <input type="number" class="form-control" name="discount_price"
                                                        id="discount_price" step="0.01">
                                                    <div class="invalid-feedback" id="discountPriceError"
                                                        style="display:none;">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <label for="discount_start_date" class="form-label">Discount Start
                                                        Date</label>
                                                    <input type="date" class="form-control" name="discount_start_date"
                                                        id="discount_start_date" min="{{ date('Y-m-d') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="discount_end_date" class="form-label">Discount End
                                                        Date</label>
                                                    <input type="date" class="form-control" name="discount_end_date"
                                                        id="discount_end_date" min="{{ date('Y-m-d') }}">
                                                    <div class="invalid-feedback" id="discountEndDateError"
                                                        style="display:none;">
                                        ...
                                        {{-- Thumbnail --}}
                                        <div class="mb-3">
                                            <label for="quizThumbnail" class="form-label">Quiz Thumbnail <span
                                                    class="text-danger">*</span></label>
                                            <input type="file" class="form-control" id="quizThumbnail"
                                                name="quizThumbnail" accept="image/*">
                                        </div>

                                        {{-- Description --}}
                                        <div class="mb-3">
                                            <label for="quizDescription" class="form-label">Quiz Description</label>
                                            <textarea id="quizDescription" name="quizDescription" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="quizDuration" class="form-label">Duration (minutes) <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="quizDuration"
                                                name="quizDuration" min="1" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="quizTotalMarks" class="form-label">Total Marks <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="quizTotalMarks"
                                                name="quizTotalMarks" min="1" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="quizPassMark" class="form-label">Passing Marks <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="quizPassMark"
                                                name="quizPassMark" min="1" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="correctAnswerMarks" class="form-label">Marks per Correct Answer
                                                <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" id="correctAnswerMarks"
                                                name="correctAnswerMarks" min="1" required>
                                        </div>

                                        <div class="mb-3">
                                            <label for="negativeMarking" class="form-label">Negative Marking (%)</label>
                                            <input type="number" class="form-control" id="negativeMarking"
                                                name="negativeMarking" min="0" max="100">
                                        </div>



                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input" id="is_one_time"
                                                name="is_one_time" value="1">
                                            <label class="form-check-label" for="is_one_time">Is One Time Quiz</label>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input" id="is_live_quiz"
                                                name="is_live_quiz" value="1">
                                        ...
                                        <div id="live_time_fields" style="display:none;">
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" class="form-control" id="live_start_time"
                                                    name="live_start_time">
                                            </div>
                                            <div class="mb-3">
                                                <label for="live_end_time" class="form-label">Live End Time</label>
                                                <input type="datetime-local" class="form-control" id="live_end_time"
                                                    name="live_end_time">
                                                <div class="invalid-feedback" id="end_time_error" style="display:none;">
                                                    End time must be later than start time.</div>
                                            </div>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input" id="is_quiz_group"
                                                name="is_quiz_group" value="1">
                                        ...
                                        <div id="quiz_group_fields" style="display:none;">
                                            ...
                                            <div id="group_warning" class="text-warning small" style="display:none;">At
                                                least one group is required when group is enabled.</div>
                                        </div>

                                        <div class="form-check mb-3 mt-3">
                                            <input type="checkbox" class="form-check-input" id="enableReview"
                                                name="enableReview" value="1">
                                            <label class="form-check-label" for="enableReview">Enable Review</label>
                                        </div>

                                        <div class="form-check mb-3">
                                            <input type="checkbox" class="form-check-input" id="showInListQuiz"
                                                name="showInListQuiz" value="1">
                                        ...
                                        <div class="form-check mb-3">
                                            ...
                                            <label class="form-check-label" for="publishStatus">Publish
                                                Immediately</label>
                                        </div>
