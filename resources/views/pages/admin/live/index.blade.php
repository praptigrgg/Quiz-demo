        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs nav-fill" id="assignmentTabs" role="tablist">
                    <li class="nav-item">
                        <button class="nav-link active py-3" data-bs-toggle="tab" data-bs-target="#all-assignments">Assigned
                            Sets</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link py-3" data-bs-toggle="tab" data-bs-target="#unassigned">Unassigned
                            Sets</button>
                    </li>
                </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (count($questions) > 1)
                                                    ...
                                                    <button class="btn btn-sm btn-light ms-2 show-questions-btn"
                                            ...
                                            <td><span
                                                    class="badge bg-info">{{ class_basename($assignment->assignable_type) }}</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li>
                                                            <form
                                                                action="{{ route('admin.live.destroy', $assignment->id) }}"
                                                                method="POST"
                                                ...
                                                <td colspan="6" class="bg-light">
                                                    <ol class="mb-0 ps-5">
                                                        @foreach ($questions as $question)
                                                            <li>{{ $question->title ?? ($question->questionText ?? 'N/A') }}
                                                            </li>
                                                        @endforeach
                                                    </ol>
                                                </td>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                assignModal.addEventListener('show.bs.modal', event => {
                    ...
                    document.getElementById('modal_assignable_id').value = button.getAttribute(
                        'data-assignable-id');
                    document.getElementById('modal_assignable_type').value = button.getAttribute(
                        'data-assignable-type');
                });
            });
        </script>
