                ...
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <tbody>
                        @forelse($participants as $index => $student)
                            @php
                                $response = $student->firstResponse;
                                $submittedAt = $response?->created_at;
                                $elapsed = $student->elapsed_time;
                                // format elapsed time nicely (HH:MM:SS)
                            ...
                            <tr>
                                ...
                                <td>{{ $elapsedFormatted }}</td> {{-- Show time --}}
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-2">
                                            <a href="#" class="dropdown-item view-answers-btn"
                                                data-assignment="{{ $assignment->id }}" data-student="{{ $student->id }}">
